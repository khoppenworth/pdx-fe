...
angular.module('ngIntlTelInput')
  .directive('ngIntlTelInput', ['ngIntlTelInput', '$log', '$window', '$parse', 'PhoneValidationService',
    function (ngIntlTelInput, $log, $window, $parse, PhoneValidationService) {
      return {
        restrict: 'A',
        require: 'ngModel',
        link: function (scope, elm, attr, ctrl) {
          ...
          ctrl.$validators.ngIntlTelInput = function (value) {
            ...
            if (!value || elm[0].value.length <= 0 ) {
              return true;
            } else if(PhoneValidationService.isValidNumber(value)){
              return true;
            } else {
